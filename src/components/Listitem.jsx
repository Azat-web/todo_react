...
const ListItem = ({ text, completed, index, onToggleCompleted, onRemoveTask, description }) => {
  ...
  return (
    <div className="todo__list-container">
      ...
      <div className="todo__list-container-descriprtion">{description}</div>
      <div className="todo__list-container-date">
        <Moment format="D MMM YYYY" withTitle>{date}</Moment>
        <div className="todo__list-container-changed">
